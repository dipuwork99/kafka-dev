...
f= open("/Users/eventsadmusr/dockererror.txt","w+")
...
class AnsibleDockerClient(Client):
    ...
    def __init__(self, argument_spec=None, supports_check_mode=False, mutually_exclusive=None,
        ...
        f.write("ImportError Line 337 : HAS_DOCKER_PY " + str(HAS_DOCKER_PY) +  "\r\n")
        ...
        if not HAS_DOCKER_PY:
            if NEEDS_DOCKER_PY2:
                ...
                f.write("ImportError Line 344 : HAS_DOCKER_PY " + str(HAS_DOCKER_PY) +  "\r\n")
